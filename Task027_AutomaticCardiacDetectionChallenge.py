...
if __name__ == "__main__":
    folder = "/data/ChenyangZhao/ACDC_Dataset/training/training"
    folder_test = "/data/ChenyangZhao/ACDC_Dataset/testing/testing"
    out_folder = "/code/nnUNetFrame/DATASET/Task027_ACDC"
